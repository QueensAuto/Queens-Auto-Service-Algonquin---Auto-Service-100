    ...
    useEffect(() => {
      const handleAnchorClick = (e: MouseEvent) => {
        ...
        if (anchor) {
          ...
          if (!href || href === '#' || href.startsWith('#disclaimer-modal')) return;
          e.preventDefault();
...
const BookingForm: FC<{t: TFunction}> = ({ t }) => {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            const response = await fetch('https://n8n.queensautoservices.com/webhook/465c85ff-f19e-4d8b-8907-c806cc9fc07b', {
                method: 'POST',
            ...
            const thankYouUrl = new URL('https://queensautoservices.com/auto-repair/thank-you-coupon.htm');
